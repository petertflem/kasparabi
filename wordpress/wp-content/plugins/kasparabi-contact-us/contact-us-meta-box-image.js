...
jQuery(document).ready(function($){
    ...
    $('.contact-us-image-thumbnail').each(function (i, element) {
        var $element = $(element);
    ...
    $('.contact-us-meta-image-button').click(function(e){
        ...
        meta_image_frame.on('select', function() {
            ...
            that.siblings('.contact-us-image').val(media_attachment.url);

            var thumbnail = that.siblings('.contact-us-image-thumbnail')
